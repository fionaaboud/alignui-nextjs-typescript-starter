export default function DetermineSplit() {
  return (
    <div className="w-[1440px] h-[900px] relative bg-white rounded-3xl  overflow-hidden">
      <div className="w-[1352px] left-[44px] top-[24px] absolute justify-between items-center inline-flex">
        <div className="h-[95px] bg-white justify-start items-center gap-2 flex">
        ...
        <div className="justify-start items-center gap-4 flex">
          <div className="justify-start items-center gap-2 flex">
            ...
            <path d="M0.5 10.5C0.5 4.97715 4.97715 0.5 10.5 0.5C16.0228 0.5 20.5 4.97715 20.5 10.5C20.5 16.0228 16.0228 20.5 10.5 20.5C4.97715 20.5 0.5 16.0228 0.5 10.5Z" fill="#1FC16B"/>
            <path d="M15.5999 7.95336L9.22547 14.3202L5.3999 10.4997L6.67479 9.22654L9.22547 11.7738L14.325 6.68018L15.5999 7.95336Z" fill="white"/>
            </svg>
            </div>
          ...
          <div className="justify-start items-center gap-2 flex">
            ...
            <div className="text-[#0e1b0d] text-sm font-normal font-['Inter'] leading-tight">Add Contributors</div>
          </div>
          <div data-svg-wrapper className="relative">
          <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M11.296 10.4991L7.5835 6.78657L8.644 5.72607L13.417 10.4991L8.644 15.2721L7.5835 14.2116L11.296 10.4991Z" fill="#99A0AE"/>
          ...
          <div className="justify-start items-center gap-2 flex">
            <div className="p-0.5 bg-[#335cff] rounded-[999px] flex-col justify-start items-center gap-0.5 inline-flex overflow-hidden">
              <div className="w-4 text-center text-white text-xs font-medium font-['Inter'] leading-none">3</div>
            </div>
            <div className="text-[#0d111b] text-sm font-normal font-['Inter'] leading-tight">Determine Split</div>
          </div>
          <div data-svg-wrapper className="relative">
          <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M11.296 10.4991L7.5835 6.78657L8.644 5.72607L13.417 10.4991L8.644 15.2721L7.5835 14.2116L11.296 10.4991Z" fill="#99A0AE"/>
      ...
      <div className="w-[468px] h-[644px] p-8 left-[486px] top-[113px] absolute bg-white rounded-[20px] shadow-[0px_1px_2px_0px_rgba(10,13,20,0.03)] border border-[#e1e3e9] flex-col justify-start items-center gap-6 inline-flex overflow-hidden">
        <div className="self-stretch h-32 flex-col justify-start items-center gap-2 flex">
          ...
          <path d="M0 48C0 21.4903 21.4903 0 48 0C74.5097 0 96 21.4903 96 48C96 74.5097 74.5097 96 48 96C21.4903 96 0 74.5097 0 48Z" fill="url(#paint0_linear_14_23658)" fill-opacity="0.1"/>
          <g filter="url(#filter0_d_14_23658)">
          ...
          <defs>
          <filter id="filter0_d_14_23658" x="14" y="15" width="68" height="68" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
          ...
          <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_14_23658"/>
          <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_14_23658" result="shape"/>
          </filter>
          <linearGradient id="paint0_linear_14_23658" x1="48" y1="0" x2="48" y2="96" gradientUnits="userSpaceOnUse">
          <stop stop-color="#717784"/>
          <stop offset="1" stop-color="#717784" stop-opacity="0"/>
          </linearGradient>
          </defs>
          ...
          <div className="self-stretch h-6 flex-col justify-start items-center gap-1 flex">
            <div className="self-stretch text-center text-[#525866] text-base font-normal font-['Inter'] leading-normal">Enter the Split</div>
          </div>
        </div>
        <div className="self-stretch justify-center items-center gap-2 inline-flex">
          <div className="grow shrink basis-0 h-[0px] border border-[#e1e3e9]"></div>
        </div>
        <div className="self-stretch h-[180px] flex-col justify-start items-center gap-3 flex">
          <div className="self-stretch justify-between items-center inline-flex">
            <div className="text-[#0e1b0d] text-sm font-normal font-['Inter'] leading-tight">marcaum.eth</div>
            <div className="self-stretch pl-3 pr-2.5 py-4 bg-white rounded-[999px] shadow-[0px_1px_2px_0px_rgba(10,13,20,0.03)] border border-[#e1e3e9] justify-center items-center gap-2 flex overflow-hidden">
              <div className="text-[#0e1b0d] text-sm font-normal font-['Inter'] leading-tight">20%</div>
            </div>
          </div>
          <div className="self-stretch justify-between items-center inline-flex">
            <div className="text-[#0e1b0d] text-sm font-normal font-['Inter'] leading-tight">vitalik.eth</div>
            <div className="self-stretch pl-3 pr-2.5 py-4 bg-white rounded-[999px] shadow-[0px_1px_2px_0px_rgba(10,13,20,0.03)] border border-[#e1e3e9] justify-center items-center gap-2 flex overflow-hidden">
              <div className="text-[#0e1b0d] text-sm font-normal font-['Inter'] leading-tight">30%</div>
            </div>
          </div>
          <div className="self-stretch justify-between items-center inline-flex">
            <div className="text-[#0e1b0d] text-sm font-normal font-['Inter'] leading-tight">afowefa.eth</div>
            <div className="self-stretch pl-3 pr-2.5 py-4 bg-white rounded-[999px] shadow-[0px_1px_2px_0px_rgba(10,13,20,0.03)] border border-[#e1e3e9] justify-center items-center gap-2 flex overflow-hidden">
              <div className="text-[#0e1b0d] text-sm font-normal font-['Inter'] leading-tight">50%</div>
            </div>
          </div>
        </div>
      </div>
      <div className="left-[425px] top-[456px] absolute text-black text-sm font-normal font-['Inter'] leading-tight">      </div>
      <div className="w-[468px] left-[486px] top-[783px] absolute justify-center items-center gap-1.5 inline-flex">
        ...
        <div className="grow shrink basis-0 h-10 p-2.5 bg-gradient-to-b from-white to-white rounded-[36px] shadow-[0px_0px_0px_1px_rgba(51,92,255,1.00)] shadow-[0px_1px_2px_0px_rgba(14,18,27,0.24)] border border-white justify-center items-center gap-1 flex overflow-hidden">
          <div className="px-1 justify-center items-center flex">
            <div className="text-white text-sm font-medium font-['Inter'] leading-tight">Next</div>
          </div>
          <div data-svg-wrapper className="relative">
          <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M13.629 9.25L9.606 5.227L10.6665 4.1665L16.5 10L10.6665 15.8335L9.606 14.773L13.629 10.75H4.5V9.25H13.629Z" fill="white"/>
          </svg>
          </div>
        </div>
      </div>
